  ...
  <div class="pending">
    ...
    <mybottons>
      <el-form :inline="true" :model="formInline">
        <el-form-item>
          <el-button type="primary" @click="add">新增店铺运营等级</el-button>
        </el-form-item>
      </el-form>
    </mybottons>
    <!-- 表格 -->
    ...
    <el-dialog
      ...
      :title="userState ? '新增店铺运营等级' : '修改店铺运营等级'"
      width="30%"
      center
...
const levelRules = ref({
  ...
  growth: [
    { required: true, message: '请输入店铺运营成长值', trigger: 'blur' }
  ],
