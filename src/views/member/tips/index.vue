<template>
  ...
  <div class="pending">
    ...
    <mybottons>
        <el-form :inline="true" :model="formInline">
          ...
          <el-form-item>
            ...
            <el-button type="primary" @click="exportTips">导出标签</el-button>
            <el-button type="primary" :disabled="!multipleSelection.length" @click="deleteTips">批量删除</el-button>
          </el-form-item>
        </el-form>
    </mybottons>
    <!-- 表格 -->
    ...
    >
      ...
      <el-table-column prop="users" label="店铺运营" />
