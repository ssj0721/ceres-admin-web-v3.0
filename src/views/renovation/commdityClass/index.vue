<template>
  ...
  <div class="pending">
    ...
    <mybottons>
      <el-button type="primary" @click="addBar">添加一级类别</el-button>
    </mybottons>
    <!-- </div> -->
...
<script setup>
import { classifyListStart, commdityClassDelete, commdityClassGetAll } from '@/api/renovation';
