...
<script setup>
import BrandSeriesForm from './form.vue'
import { brandSeriesAdd, brandSeriesEdit, brandSeriesDel, brandSeriesGetList, brandSeriesSearch } from '@/api/trademark/bd/brandSeries'
...
function handleGetTable () {
  ...
  brandSeriesSearch({ ...formInline.value, page: queryOptions.value.page, pageSize: queryOptions.value.pageSize }).then(res => {
    list.value = res.data.list
    tableOptions.value.total = res.data.total
  }).catch(() => {
    brandSeriesGetList(queryOptions.value).then(res => {
      list.value = res.data.list
      tableOptions.value.total = res.data.total
    })
  }).finally(() => {
...
function handleDelete (item) {
  brandSeriesDel({ id: item.id }).then(() => {
