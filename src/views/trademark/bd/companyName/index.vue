...
<script setup>
import CompanyNameForm from './form.vue'
import { companyNameAdd, companyNameEdit, companyNameDel, companyNameGetList, companyNameSearch } from '@/api/trademark/bd/companyName'
...
function handleGetTable () {
  ...
  companyNameSearch({ ...formInline.value, page: queryOptions.value.page, pageSize: queryOptions.value.pageSize }).then(res => {
    list.value = res.data.list
    tableOptions.value.total = res.data.total
  }).catch(() => {
    companyNameGetList(queryOptions.value).then(res => {
      list.value = res.data.list
      tableOptions.value.total = res.data.total
    })
  }).finally(() => {
...
function handleDelete (item) {
  companyNameDel({ id: item.id }).then(() => {
