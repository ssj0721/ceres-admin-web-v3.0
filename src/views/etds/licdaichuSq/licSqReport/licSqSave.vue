    ...
    <div class="container">
      <div class="content-area">
        ...
        <div class="result-section">
          ...
          <div class="radio-group">
            <el-radio-group v-model="radioValue">
              <el-radio
                v-for="item in licSqSaveFormOption.resultOptions"
                :key="item.value"
                :label="item.value"
                :disabled="isDisabled"
              >
        ...
        <div class="detail-section">
          ...
          <ZcDetailForm
            v-model="baseData"
            :form-config="licSqSaveFormOption.baseFormConfig"
          />
        </div>
        ...
        <div class="detail-section">
          ...
          <ZcDetailForm
            v-model="detailData"
            :form-config="licSqSaveFormOption.detailFormConfig"
          />
        </div>
        ...
        <div class="detail-section">
          ...
          <ZcDetailForm
            v-model="problemData"
            :form-config="licSqSaveFormOption.problemFormConfig"
          />
        </div>
      </div>
    </div>
...
import { licSqSaveFormOption } from './option';
