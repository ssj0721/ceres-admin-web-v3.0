    ...
    <mybottons>
      <el-form :inline="true" :model="searchData">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="add(1)">新增父级目录</el-button>
          <el-button type="primary" @click="add(2)">新增子级菜单</el-button>
          <el-button type="primary" @click="add(3)">新增子级按钮</el-button>
        </el-form-item>
      </el-form>
    </mybottons>
    <!-- </div> -->
...
const handleSelectionChange = (val) => {
  ...
  console.log('选择的列表',multipleSelection.value);
}
...
const add = (index) => {
  ...
  getMaxSort().then((res) => {
    ...
    if (index === 1) {
      ...
      addForm.value.sort = parseInt(res.data)
      console.log('新增父目录的addForm.value',addForm.value);
