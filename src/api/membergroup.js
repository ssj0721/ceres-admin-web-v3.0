...
// *************角色管理*************
// 角色管理查询
export function groupGetall(data) {
  return request({
    url: '/membergroup/getAll',
    method: 'post',
    data,
...
// 角色详情查询
export function groupGetById(data) {
  return request({
    url: '/membergroup/getById',
    method: 'post',
    data,
  })
}
...
// 数据权限分配查询
export function getGroupAccount(data) {
  return request({
    url: '/membergroup/getGroupAccount',
    method: 'post',
    data,
  })
}
...
//   return request({
//     url: '/membergroup/getMerchantList',
//     method: 'post',
//     data,
//   })
// }
...
// 菜单分配
export function confirmGroupAccount(data) {
  return request({
    url: '/membergroup/confirmGroupAccount',
    method: 'post',
    data,
  })
}
