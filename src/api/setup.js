...
// 获取审款账号
export function getShenKuanAccounts(data) {
  return request({
    url: '/platform_user/getShenKuanAccounts',
    method: 'post',
    data,
  })
}
...
// 更新审款账号
export function updateShenKuanAccounts(data) {
  return request({
    url: '/platform_user/updateShenKuanAccounts',
    method: 'post',
    data,
  })
}
...
// 上传审款图片到供应链
export function uploadSkImageToGyl(data) {
  return request({
    url: '/platform_user/uploadSkImageToGyl',
    method: 'post',
    data,
  })
}
...
// 批量授权
export function moreEditSave(data) {
  return request({
    url: '/platform_user/moreEditSave',
    method: 'post',
    data,
  })
}
...
// 数据权限分配查询
export function getDataRolePermission(data) {
  return request({
    url: '/role/getDataRolePermission',
    method: 'post',
    data,
  })
}
...
// 菜单分配
export function confirmDataRole(data) {
  return request({
    url: '/role/confirmDataRole',
    method: 'post',
    data,
  })
}
