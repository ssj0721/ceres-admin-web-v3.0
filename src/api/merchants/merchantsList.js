...
export function getMerchants() {
  return request({
    url: '/merchants_user/getMerchants',
    method: 'post',
  })
}

export function getGylMerchants() {
  return request({
    url: '/merchants_user/getGylMerchants',
    method: 'post',
  })
}

export function getShenKuanMerchants() {
  return request({
    url: '/merchants_user/addMerchants',
    method: 'post',
  })
}
