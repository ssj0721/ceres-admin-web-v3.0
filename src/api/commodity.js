...
export function selectClassifyId(data) {
  return request({
    url: '/product/selectClassifyId',
    method: 'post',
    data,
  })
}
...
// 快速批量新增商品
export function getQuickAdd(data) {
  return request({
    url: '/product/quickAdd',
    method: 'post',
    data,
  })
}
...
// 从以图搜图的联营商私有图库结果里新增
export function searchResultAdd(data) {
  return request({
    url: '/product/searchResultAdd',
    method: 'post',
    data,
  })
}
...
// 商品分类
export function getClassifypro(data) {
  return request({
